...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        public void TestPasswordHelperReturnsFalse()
        {
            ...
            string passwordHash = "sxnIcZd988wC8MYWcQVQjQ==.FKd5Z/jwxPv3a63lX+uvQ0+P7EuNYZybvkmdhbnkIHA=";
        ...
        {
            Assert.Throws<FormatException>(() => PasswordHelper.VerifyPassword(password, passwordHash)); //Zelf uitwerken zodat de test slaagt!
        }
    }
}